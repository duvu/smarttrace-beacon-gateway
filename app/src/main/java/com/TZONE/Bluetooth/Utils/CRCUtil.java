...
/**
 * CRC-CCITT Algorithm validation class
...
public class CRCUtil {
    ...
    /**
     *
     * @param reg_init CRC check initial value
     * @param message Check the value
     * @return
     */
    ...
    /**
     * Generates a CRC check code based on the data
     *
     * @param message
     *            byte
     *
     * @return int Return check code
     */
    public static int do_crc(byte[] message) {
        // When calculating the CRC check, the initial value starts at 0x0000.
        int crc_reg = 0x0000;
     ...
     * @param crc Check the code value
     * @return
     */
    ...
    /**
     * For the use of db44 structure code, the array after the two for the CRC-check code value
     * @param messages
     * @return
     */
